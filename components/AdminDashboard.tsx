                    ...
                    <div className="bg-white rounded-[2.5rem] w-full max-w-4xl p-10 shadow-2xl animate-in zoom-in duration-300 relative my-10">
                        <div className="flex justify-between items-start mb-8">
                            <div>
                                ...
                                <p className="text-slate-500 text-sm mt-1">Conecta Odoo con la plataforma de analítica y catálogo.</p>
                            </div>
                        ...
                        <form onSubmit={handleSaveClient} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="pt-4 flex gap-3">
                                    <button type="button" onClick={() => setIsEditing(false)} className="flex-1 p-4 bg-slate-100 text-slate-600 rounded-2xl font-bold hover:bg-slate-200 transition-all">Cancelar</button>
                                    <button type="submit" disabled={isLoading} className="flex-[2] p-4 bg-brand-600 text-white rounded-2xl font-bold shadow-xl shadow-brand-100 hover:bg-brand-700 active:scale-95 transition-all">
