           ...
           <section className="bg-white p-10 rounded-[3rem] shadow-sm border border-slate-100 space-y-8">
            ...
            <div className="space-y-4">
               <div className="p-6 bg-[#742284]/5 rounded-[2.5rem] border border-[#742284]/10 space-y-3">
                  ...
                  <input type="text" placeholder="Número" className="w-full p-3 bg-white border-none rounded-xl text-xs font-black shadow-inner" value={currentConfig.yapeNumber || ''} onChange={e => setCurrentConfig({...currentConfig, yapeNumber: e.target.value})} />
                  <input type="text" placeholder="Titular" className="w-full p-3 bg-white border-none rounded-xl text-[9px] font-black uppercase shadow-inner" value={currentConfig.yapeName || ''} onChange={e => setCurrentConfig({...currentConfig, yapeName: e.target.value})} />
               </div>
               <div className="p-6 bg-[#00A9E0]/5 rounded-[2.5rem] border border-[#00A9E0]/10 space-y-3">
                  ...
                  <input type="text" placeholder="Número" className="w-full p-3 bg-white border-none rounded-xl text-xs font-black shadow-inner" value={currentConfig.plinNumber || ''} onChange={e => setCurrentConfig({...currentConfig, plinNumber: e.target.value})} />
                  <input type="text" placeholder="Titular" className="w-full p-3 bg-white border-none rounded-xl text-[9px] font-black uppercase shadow-inner" value={currentConfig.plinName || ''} onChange={e => setCurrentConfig({...currentConfig, plinName: e.target.value})} />
               </div>
            </div>
          </section>
