        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
           ...
           <div className="space-y-8 p-10 bg-purple-50/50 rounded-[3.5rem] border border-purple-100 group">
              <div className="flex items-center gap-4 mb-4">
                 <div className="w-14 h-14 bg-purple-600 rounded-[1.5rem] flex items-center justify-center text-white font-black text-xl">Y</div>
                 <h4 className="text-lg font-black text-purple-900 uppercase tracking-tighter">Cuenta Yape</h4>
              </div>
              <div className="space-y-6">
                 <div>
                    <label className="text-[10px] font-black text-purple-900 uppercase tracking-widest block mb-2 ml-4">Titular</label>
                 ...
                 <div>
                    <label className="text-[10px] font-black text-purple-900 uppercase tracking-widest block mb-2 ml-4">Número Celular</label>
                    <div className="relative">
                 ...
                 <div className="relative aspect-square bg-white rounded-[2.5rem] border border-dashed border-purple-200 flex items-center justify-center p-8 overflow-hidden shadow-inner">
                    ...
                    <label className="absolute inset-0 bg-purple-600/90 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer transition-all">
                       ...
                       <span className="text-[10px] font-black text-white uppercase">Cargar QR Yape</span>
           ...
           <div className="space-y-8 p-10 bg-blue-50/50 rounded-[3.5rem] border border-blue-100 group">
              <div className="flex items-center gap-4 mb-4">
                 <div className="w-14 h-14 bg-blue-600 rounded-[1.5rem] flex items-center justify-center text-white font-black text-xl">P</div>
                 <h4 className="text-lg font-black text-blue-900 uppercase tracking-tighter">Cuenta Plin</h4>
              </div>
              <div className="space-y-6">
                 <div>
                    <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest block mb-2 ml-4">Titular</label>
                    <div className="relative">
                 ...
                 <div>
                    <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest block mb-2 ml-4">Número Celular</label>
                    <div className="relative">
                 ...
                 <div className="relative aspect-square bg-white rounded-[2.5rem] border border-dashed border-blue-200 flex items-center justify-center p-8 overflow-hidden shadow-inner">
                    ...
                    <label className="absolute inset-0 bg-blue-600/90 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center cursor-pointer transition-all">
                       <Upload className="text-white w-10 h-10 mb-2 animate-bounce"/>
                       <span className="text-[10px] font-black text-white uppercase">Cargar QR Plin</span>
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <section className="bg-white p-10 rounded-[4rem] shadow-xl border border-slate-100">
             <h3 className="text-xl font-black text-slate-800 uppercase tracking-tighter mb-10 flex items-center gap-4">
               <Paintbrush className="w-7 h-7 text-brand-500"/> Colores de Marca
             </h3>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 bg-slate-50 rounded-3xl flex items-center gap-6">
                   <input type="color" className="w-14 h-14 rounded-2xl cursor-pointer shadow-lg" value={currentConfig.colorPrimario || '#84cc16'} onChange={e => setCurrentConfig({...currentConfig, colorPrimario: e.target.value})} />
                   <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Color Primario</span>
                </div>
                <div className="p-6 bg-slate-50 rounded-3xl flex items-center gap-6">
                   <input type="color" className="w-14 h-14 rounded-2xl cursor-pointer shadow-lg" value={currentConfig.colorSecundario || '#1e293b'} onChange={e => setCurrentConfig({...currentConfig, colorSecundario: e.target.value})} />
           ...
           <section className="bg-white p-10 rounded-[4rem] shadow-xl border border-slate-100 space-y-8">
             ...
             <div className="space-y-4">
                ...
                <div className="pt-6 border-t border-slate-100 space-y-6">
                   <label className="block text-[11px] font-black text-slate-400 uppercase tracking-widest ml-4">WhatsApp de Pedidos</label>
                   <div className="relative">
                      <ShoppingCart className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-brand-600"/>
                      <input type="text" placeholder="CELULAR PARA PEDIDOS" className="w-full pl-14 pr-5 py-5 bg-brand-50 border border-brand-100 rounded-[1.5rem] text-[11px] font-bold outline-none" value={currentConfig.whatsappNumbers || ''} onChange={e => setCurrentConfig({...currentConfig, whatsappNumbers: e.target.value})} />
                   </div>
                   <label className="block text-[11px] font-black text-slate-400 uppercase tracking-widest ml-4">WhatsApp de Soporte</label>
                   <div className="relative">
                      <MessageCircle className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-emerald-500"/>
                      <input type="text" placeholder="CELULAR PARA AYUDA" className="w-full pl-14 pr-5 py-5 bg-slate-50 rounded-[1.5rem] text-[11px] font-bold outline-none" value={currentConfig.whatsappHelpNumber || ''} onChange={e => setCurrentConfig({...currentConfig, whatsappHelpNumber: e.target.value})} />
                   </div>
                </div>

                <div className="space-y-4 pt-4 border-t border-slate-100">
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Lema del Footer</label>
                    <textarea 
